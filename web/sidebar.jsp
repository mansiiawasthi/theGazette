        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="sidebar-item search">
                    <b>Hey wants to browse NEWs</b>
                    <form id="search_form" name="gs" method="GET" action="newjsAPI.jsp">
                        <input type="text" name="q" class="searchText" placeholder="type to search NEWS..." autocomplete="on">
                        <input type="button" id="b1" value="go to Search page" onclick="search_form.submit()"/> 
                    </form>
                </div>
            </div>
            <div class="col-lg-12">
